...
#include "tutorial20/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial20::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial20::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
#include "tutorial20/input/ClientInputMessages.h"
#include "tutorial20/options/ClientDefaultOptions.h"
...
public:
    ...
    using ClientProtocolOptions = 
        tutorial20::options::DataViewDefaultOptionsT<
            tutorial20::options::ClientDefaultOptions
        >;
        
    // Definition of all the used message classes
    using ConnectMsg = tutorial20::message::Connect<Message, ClientProtocolOptions>;
    using Msg1 = tutorial20::message::Msg1<Message, ClientProtocolOptions>;
    using Msg2 = tutorial20::message::Msg2<Message, ClientProtocolOptions>;
    using Msg3 = tutorial20::message::Msg3<Message, ClientProtocolOptions>;
...
private:
    ...
    using Frame = 
        tutorial20::frame::Frame<
            Message,
            tutorial20::input::ClientInputMessages<Message, ClientProtocolOptions>,

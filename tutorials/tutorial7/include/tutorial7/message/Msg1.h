...
#include "tutorial7/message/Msg1Common.h"
...
/// @see @ref Msg1
/// @headerfile tutorial7/message/Msg1.h
...
class Msg1 : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<tutorial7::MsgId_M1>,
...
public:
    ...
    {
        return tutorial7::message::Msg1Common::name();
    }

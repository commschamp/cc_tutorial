...
#include "tutorial7/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial7::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial7::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

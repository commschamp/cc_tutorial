...
#include "tutorial7/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial7::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial7::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

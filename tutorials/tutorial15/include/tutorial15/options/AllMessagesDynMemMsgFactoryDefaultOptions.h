...
#include "tutorial15/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial15::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial15::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

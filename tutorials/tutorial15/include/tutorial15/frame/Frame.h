...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial15::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return tutorial15::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

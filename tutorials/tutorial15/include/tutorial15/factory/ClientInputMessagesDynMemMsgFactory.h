...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 2 /* 0x2 */: return MsgPtr(new tutorial15::message::Msg2<TInterface, TProtOptions>);
            case 3 /* 0x3 */: return MsgPtr(new tutorial15::message::Msg3<TInterface, TProtOptions>);
            default: break;
        }

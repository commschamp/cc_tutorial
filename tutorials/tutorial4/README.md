...
- `Msg1::Field_f1` - generated by the `COMMS_MSG_FIELDS_NAMES()` macro in the message definition and 
  ...
  (extends [comms::field::ArrayList](https://arobenko.github.io/comms_doc/classcomms_1_1field_1_1ArrayList.html)).
...
- `Msg1::Field_f1::ValueType::value_type::Field_prop2::Field_val` - gives us a type of **Val** member of
  ...
  which is **&lt;float&gt;** field (extends [comms::field::FloatValue](https://arobenko.github.io/comms_doc/classcomms_1_1field_1_1FloatValue.html)).
...
```
It gets the job done, however the [commsdsl2comms](https://github.com/arobenko/commsdsl) code generator
overrode the definition of inherited `currFieldExec()` from [comms::field::Variant](https://arobenko.github.io/comms_doc/classcomms_1_1field_1_1Variant.html)
...
- All the **&lt;variant&gt;** fields are defined by extending 
  [comms::field::Variant](https://arobenko.github.io/comms_doc/classcomms_1_1field_1_1Variant.html) class.
...
- To determine the type of the held member and dispatch it to the appropriate handler the 
  ...
  [comms::field::Variant::currFieldExec()](https://arobenko.github.io/comms_doc/classcomms_1_1field_1_1Variant.html)
  for documentation).

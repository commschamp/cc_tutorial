...
#include "tutorial4/input/ClientInputMessages.h"
...
/// @note Defined in tutorial4/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial4::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial4::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial4::options::DefaultOptions.
/// @headerfile tutorial4/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial4::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial4::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial4::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial4::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial4::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial4::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

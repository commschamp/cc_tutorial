...
/// @note Defined in tutorial4/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial4::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial4::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial4::options::DefaultOptions.
/// @headerfile tutorial4/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(tutorial4::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial4::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial4::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial4::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial4::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial4::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

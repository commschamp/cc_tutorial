...
#include "tutorial4/input/ServerInputMessages.h"
...
///     like @ref tutorial4::options::DefaultOptions.
...
///     @code
///     using MyInterface = tutorial4::Message<...>;
///     using MyMsg1 = tutorial4::message::Msg1<MyInterface, tutorial4::options::DefaultOptions>;
///     using MyMsg2 = tutorial4::message::Msg2<MyInterface, tutorial4::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in tutorial4/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case tutorial4::MsgId_M1:
    {
        using MsgType = tutorial4::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial4::MsgId_M2:
    {
        using MsgType = tutorial4::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     tutorial4::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial4::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial4::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial4::options::DefaultOptions.
/// @headerfile tutorial4/dispatch/DispatchServerInputMessage.h
template <typename TProtOptions = tutorial4::options::DefaultOptions>
struct ServerInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial4::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial4::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial4::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial4::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial4::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial4::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref tutorial4::options::DefaultOptions as template parameter.
/// @note Defined in tutorial4/dispatch/DispatchServerInputMessage.h

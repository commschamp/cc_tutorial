...
public:
    ...
    using MemberNameInfo = tutorial4::field::TlvPropCommon::MemberNameInfo;

    /// @brief Type returned from @ref memberNamesMap() member function.
    /// @see @ref tutorial4::field::TlvPropCommon::MemberNamesMapInfo.
    using MemberNamesMapInfo = tutorial4::field::TlvPropCommon::MemberNamesMapInfo;
    ...
    /// @see @ref tutorial4::field::TlvPropCommon::memberName().
    static const char* memberName(std::size_t idx)
    {
        return tutorial4::field::TlvPropCommon::memberName(idx);
    }
    ...
    /// @see @ref tutorial4::field::TlvPropCommon::memberNamesMap().
    static MemberNamesMapInfo memberNamesMap()
    {
        return tutorial4::field::TlvPropCommon::memberNamesMap();
    }

...
public:
    ...
    using MemberNameInfo = tutorial4::field::KeyValuePropCommon::MemberNameInfo;

    /// @brief Type returned from @ref memberNamesMap() member function.
    /// @see @ref tutorial4::field::KeyValuePropCommon::MemberNamesMapInfo.
    using MemberNamesMapInfo = tutorial4::field::KeyValuePropCommon::MemberNamesMapInfo;
    ...
    /// @see @ref tutorial4::field::KeyValuePropCommon::memberName().
    static const char* memberName(std::size_t idx)
    {
        return tutorial4::field::KeyValuePropCommon::memberName(idx);
    }
    ...
    /// @see @ref tutorial4::field::KeyValuePropCommon::memberNamesMap().
    static MemberNamesMapInfo memberNamesMap()
    {
        return tutorial4::field::KeyValuePropCommon::memberNamesMap();
    }

...
#include "tutorial4/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial4::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial4::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

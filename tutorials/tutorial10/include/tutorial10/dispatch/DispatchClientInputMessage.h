...
/// @note Defined in tutorial10/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial10::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial10::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial10::options::DefaultOptions.
/// @headerfile tutorial10/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial10::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial10::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial10::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial10::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial10::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial10::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

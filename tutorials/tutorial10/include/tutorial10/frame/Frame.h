...
#include "tutorial10/field/MsgId.h"
#include "tutorial10/frame/FrameCommon.h"
...
/// @see @ref Frame
/// @headerfile tutorial10/frame/Frame.h
...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial10::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return tutorial10::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial10::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };
...
template <
   typename TMessage,
   typename TAllMessages = tutorial10::input::AllMessages<TMessage>,
   typename TOpt = tutorial10::options::DefaultOptions
>
class Frame : public

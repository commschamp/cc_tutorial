...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 2 /* 0x2 */: return MsgPtr(new tutorial10::message::Msg2<TInterface, TProtOptions>);
            case 3 /* 0x3 */: return MsgPtr(new tutorial10::message::Msg3<TInterface, TProtOptions>);
            case 4 /* 0x4 */: return MsgPtr(new tutorial10::message::Msg4<TInterface, TProtOptions>);
            case 5 /* 0x5 */: return MsgPtr(new tutorial10::message::Msg5<TInterface, TProtOptions>);
            default: break;
        }

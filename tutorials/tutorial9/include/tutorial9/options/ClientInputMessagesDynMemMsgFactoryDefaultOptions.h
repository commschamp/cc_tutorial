...
#include "tutorial9/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial9::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial9::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

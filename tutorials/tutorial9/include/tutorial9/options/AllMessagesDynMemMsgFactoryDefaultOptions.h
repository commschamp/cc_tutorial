...
#include "tutorial9/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial9::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial9::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

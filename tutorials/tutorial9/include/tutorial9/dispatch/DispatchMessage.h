...
#include <cstdint>
#include "tutorial9/input/AllMessages.h"
...
/// @note Defined in tutorial9/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial9::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial9::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial9::options::DefaultOptions.
/// @headerfile tutorial9/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial9::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial9::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial9::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial9::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

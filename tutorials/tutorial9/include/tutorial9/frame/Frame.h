...
#include "tutorial9/field/MsgId.h"
#include "tutorial9/frame/FrameCommon.h"
...
/// @see @ref Frame
/// @headerfile tutorial9/frame/Frame.h
...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial9::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return tutorial9::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial9::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };

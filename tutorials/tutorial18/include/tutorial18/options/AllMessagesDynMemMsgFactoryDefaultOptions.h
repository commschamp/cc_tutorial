...
#include "tutorial18/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial18::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial18::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

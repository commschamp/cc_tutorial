...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            case tutorial18::MsgId_M1: 
                if (idx == 0) {
                    return MsgPtr(new tutorial18::message::Msg1_1<TInterface, TProtOptions>);
                }
                if (idx == 1) {
                    return MsgPtr(new tutorial18::message::Msg1_2<TInterface, TProtOptions>);
                }
                if (idx == 2) {
                    return MsgPtr(new tutorial18::message::Msg1_3<TInterface, TProtOptions>);
                }
                break;

            case tutorial18::MsgId_M2: 
                if (idx == 0) {
                    return MsgPtr(new tutorial18::message::Msg2_1<TInterface, TProtOptions>);
                }
                if (idx == 1) {
                    return MsgPtr(new tutorial18::message::Msg2_2<TInterface, TProtOptions>);
                }
                if (idx == 2) {
                    return MsgPtr(new tutorial18::message::Msg2_3<TInterface, TProtOptions>);
                }
                break;
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (id)
        {
            case tutorial18::MsgId_M1: return 3U;
            case tutorial18::MsgId_M2: return 3U;
            default: break;
        }

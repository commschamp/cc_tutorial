...
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define TUTORIAL25_ALIASES_FOR_ALL_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    TUTORIAL25_ALIASES_FOR_ALL_MESSAGES(prefix_, suffix_, interface_, tutorial25::options::DefaultOptions)

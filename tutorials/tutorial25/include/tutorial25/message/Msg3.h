...
#include "tutorial25/message/Msg3Common.h"
...
/// @see @ref Msg3
/// @headerfile tutorial25/message/Msg3.h
...
class Msg3 : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<tutorial25::MsgId_M3>,
...
public:
    ...
    {
        return tutorial25::message::Msg3Common::name();
    }
};

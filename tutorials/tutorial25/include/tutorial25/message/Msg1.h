...
#include "tutorial25/message/Msg1Common.h"
...
/// @see @ref Msg1
/// @headerfile tutorial25/message/Msg1.h
...
class Msg1 : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<tutorial25::MsgId_M1>,
...
public:
    ...
    {
        return tutorial25::message::Msg1Common::name();
    }
};

...
#include "tutorial25/message/Msg10Common.h"
...
/// @see @ref Msg10
/// @headerfile tutorial25/message/Msg10.h
...
class Msg10 : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<tutorial25::MsgId_M10>,
...
public:
    ...
    {
        return tutorial25::message::Msg10Common::name();
    }
};

...
#include "tutorial25/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial25::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial25::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

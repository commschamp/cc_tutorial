...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 1 /* 0x1 */: return MsgPtr(new tutorial25::message::Msg1<TInterface, TProtOptions>);
            case 2 /* 0x2 */: return MsgPtr(new tutorial25::message::Msg2<TInterface, TProtOptions>);
            case 3 /* 0x3 */: return MsgPtr(new tutorial25::message::Msg3<TInterface, TProtOptions>);
            case 4 /* 0x4 */: return MsgPtr(new tutorial25::message::Msg4<TInterface, TProtOptions>);
            case 5 /* 0x5 */: return MsgPtr(new tutorial25::message::Msg5<TInterface, TProtOptions>);
            case 6 /* 0x6 */: return MsgPtr(new tutorial25::message::Msg6<TInterface, TProtOptions>);
            case 7 /* 0x7 */: return MsgPtr(new tutorial25::message::Msg7<TInterface, TProtOptions>);
            case 8 /* 0x8 */: return MsgPtr(new tutorial25::message::Msg8<TInterface, TProtOptions>);
            case 9 /* 0x9 */: return MsgPtr(new tutorial25::message::Msg9<TInterface, TProtOptions>);
            case 10 /* 0xa */: return MsgPtr(new tutorial25::message::Msg10<TInterface, TProtOptions>);
            default: break;
        }

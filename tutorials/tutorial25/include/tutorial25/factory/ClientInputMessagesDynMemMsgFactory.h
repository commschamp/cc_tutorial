...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            case tutorial25::MsgId_M1: return MsgPtr(new tutorial25::message::Msg1<TInterface, TProtOptions>);
            case tutorial25::MsgId_M2: return MsgPtr(new tutorial25::message::Msg2<TInterface, TProtOptions>);
            case tutorial25::MsgId_M3: return MsgPtr(new tutorial25::message::Msg3<TInterface, TProtOptions>);
            case tutorial25::MsgId_M4: return MsgPtr(new tutorial25::message::Msg4<TInterface, TProtOptions>);
            case tutorial25::MsgId_M5: return MsgPtr(new tutorial25::message::Msg5<TInterface, TProtOptions>);
            case tutorial25::MsgId_M6: return MsgPtr(new tutorial25::message::Msg6<TInterface, TProtOptions>);
            case tutorial25::MsgId_M7: return MsgPtr(new tutorial25::message::Msg7<TInterface, TProtOptions>);
            case tutorial25::MsgId_M8: return MsgPtr(new tutorial25::message::Msg8<TInterface, TProtOptions>);
            case tutorial25::MsgId_M9: return MsgPtr(new tutorial25::message::Msg9<TInterface, TProtOptions>);
            case tutorial25::MsgId_M10: return MsgPtr(new tutorial25::message::Msg10<TInterface, TProtOptions>);
            default: break;
        }
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (id)
        {
            case tutorial25::MsgId_M1: return 1U;
            case tutorial25::MsgId_M2: return 1U;
            case tutorial25::MsgId_M3: return 1U;
            case tutorial25::MsgId_M4: return 1U;
            case tutorial25::MsgId_M5: return 1U;
            case tutorial25::MsgId_M6: return 1U;
            case tutorial25::MsgId_M7: return 1U;
            case tutorial25::MsgId_M8: return 1U;
            case tutorial25::MsgId_M9: return 1U;
            case tutorial25::MsgId_M10: return 1U;
            default: break;
        }

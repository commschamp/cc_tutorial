...
#include "tutorial25/field/MsgId.h"
#include "tutorial25/frame/FrameCommon.h"
...
/// @see @ref Frame
/// @headerfile tutorial25/frame/Frame.h
...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial25::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return tutorial25::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial25::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };
...
template <
   typename TMessage,
   typename TAllMessages = tutorial25::input::AllMessages<TMessage>,
   typename TOpt = tutorial25::options::DefaultOptions
>
class Frame : public

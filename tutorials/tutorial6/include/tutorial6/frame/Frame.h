...
#include "tutorial6/field/MsgId.h"
#include "tutorial6/frame/FrameCommon.h"
...
/// @see @ref Frame
/// @headerfile tutorial6/frame/Frame.h
...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial6::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return tutorial6::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial6::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };

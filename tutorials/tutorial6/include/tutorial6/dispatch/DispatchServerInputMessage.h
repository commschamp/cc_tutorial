...
#include "tutorial6/input/ServerInputMessages.h"
...
/// @note Defined in tutorial6/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial6::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial6::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial6::options::DefaultOptions.
/// @headerfile tutorial6/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial6::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial6::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial6::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial6::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial6::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial6::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

...
#include "tutorial6/input/ClientInputMessages.h"
...
///     like @ref tutorial6::options::DefaultOptions.
...
///     @code
///     using MyInterface = tutorial6::Message<...>;
///     using MyMsg1 = tutorial6::message::Msg1<MyInterface, tutorial6::options::DefaultOptions>;
///     using MyMsg2 = tutorial6::message::Msg2<MyInterface, tutorial6::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in tutorial6/dispatch/DispatchClientInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case tutorial6::MsgId_M1:
    {
        using MsgType = tutorial6::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial6::MsgId_M2:
    {
        using MsgType = tutorial6::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial6::MsgId_M3:
    {
        using MsgType = tutorial6::message::Msg3<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     tutorial6::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchClientInputMessage()
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial6::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial6::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial6::options::DefaultOptions.
/// @headerfile tutorial6/dispatch/DispatchClientInputMessage.h
template <typename TProtOptions = tutorial6::options::DefaultOptions>
struct ClientInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial6::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial6::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial6::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchClientInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial6::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial6::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial6::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref tutorial6::options::DefaultOptions as template parameter.
/// @note Defined in tutorial6/dispatch/DispatchClientInputMessage.h

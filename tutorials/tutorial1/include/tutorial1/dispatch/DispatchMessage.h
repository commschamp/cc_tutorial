...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial1::options::DefaultOptions.
/// @headerfile "tutorial1/dispatch/DispatchMessage.h"
...
struct MsgDispatcher
{
    ...
    static auto dispatch(tutorial1::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial1::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<tutorial1::options::DefaultOptions>;

...
#include "tutorial26/field/FieldBase.h"
#include "tutorial26/frame/FrameCommon.h"
#include "tutorial26/input/AllMessages.h"
...
/// @see @ref Frame
/// @headerfile tutorial26/frame/Frame.h
template <typename TOpt = tutorial26::options::DefaultOptions>
struct FrameLayers
{
    /// @brief Scope for field(s) of @ref Data layer.
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial26::frame::FrameLayers::Data layer
        class Field : public
            comms::field::ArrayList<
                tutorial26::field::FieldBase<>,
                std::uint8_t,
    ...
    struct IdMembers
    {
        ...
        public:
            ...
            {
                return tutorial26::frame::FrameLayersCommon::IdMembersCommon::IdFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial26::frame::FrameLayersCommon::IdMembersCommon::IdFieldCommon::name();
            }
        };
    };
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return tutorial26::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial26::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };
...
template <
   typename TMessage,
   typename TAllMessages = tutorial26::input::AllMessages<TMessage>,
   typename TOpt = tutorial26::options::DefaultOptions
>
class Frame : public

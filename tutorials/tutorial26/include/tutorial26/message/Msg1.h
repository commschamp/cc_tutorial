...
#include "tutorial26/message/Msg1Common.h"
...
/// @see @ref Msg1
/// @headerfile tutorial26/message/Msg1.h
...
/// @tparam TOpt Extra options
/// @headerfile tutorial26/message/Msg1.h
template <typename TMsgBase, typename TOpt = tutorial26::options::DefaultOptions>
class Msg1 : public
    comms::MessageBase<
        TMsgBase,
...
public:
    ...
    {
        return tutorial26::message::Msg1Common::name();
    }
};

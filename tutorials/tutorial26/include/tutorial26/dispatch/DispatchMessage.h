...
/// @note Defined in tutorial26/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial26::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial26::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial26::options::DefaultOptions.
/// @headerfile tutorial26/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial26::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial26::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial26::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial26::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

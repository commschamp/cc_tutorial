...
#include "tutorial26/factory/AllMessagesDynMemMsgFactory.h"
...
struct AllMessagesDynMemMsgFactoryDefaultOptionsT : public TBase
{
    ...
    using MsgFactory =
        tutorial26::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
#include "tutorial3/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial3::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial3::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

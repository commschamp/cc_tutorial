...
/// @note Defined in tutorial3/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial3::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial3::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial3::options::DefaultOptions.
/// @headerfile tutorial3/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial3::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial3::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial3::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial3::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

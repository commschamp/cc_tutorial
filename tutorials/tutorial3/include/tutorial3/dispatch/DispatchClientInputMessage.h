...
#include <cstdint>
#include "tutorial3/input/ClientInputMessages.h"
...
/// @note Defined in tutorial3/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial3::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial3::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial3::options::DefaultOptions.
/// @headerfile tutorial3/dispatch/DispatchClientInputMessage.h
template <typename TProtOptions = tutorial3::options::DefaultOptions>
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial3::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial3::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial3::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial3::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

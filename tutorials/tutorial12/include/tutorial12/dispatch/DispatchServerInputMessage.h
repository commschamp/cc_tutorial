...
///     like @ref tutorial12::options::DefaultOptions.
...
///     @code
///     using MyInterface = tutorial12::Message<...>;
///     using MyMsg1 = tutorial12::message::Msg1<MyInterface, tutorial12::options::DefaultOptions>;
///     using MyMsg2 = tutorial12::message::Msg2<MyInterface, tutorial12::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in tutorial12/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case tutorial12::MsgId_M1:
    {
        using MsgType = tutorial12::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial12::MsgId_M2:
    {
        using MsgType = tutorial12::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial12::MsgId_M3:
    {
        using MsgType = tutorial12::message::Msg3<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     tutorial12::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial12::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial12::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial12::options::DefaultOptions.
/// @headerfile tutorial12/dispatch/DispatchServerInputMessage.h
template <typename TProtOptions = tutorial12::options::DefaultOptions>
struct ServerInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial12::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial12::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial12::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial12::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial12::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial12::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref tutorial12::options::DefaultOptions as template parameter.
/// @note Defined in tutorial12/dispatch/DispatchServerInputMessage.h

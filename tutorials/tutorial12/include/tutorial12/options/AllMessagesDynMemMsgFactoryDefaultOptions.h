...
#include "tutorial12/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial12::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial12::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
#include "tutorial12/input/ServerInputMessages.h"
#include "tutorial12/options/ServerDefaultOptions.h"
#include "BareMetalProtocolOptions.h"
...
private:
    ...
    using Frame = 
        tutorial12::frame::Frame<
            Message,
            tutorial12::input::ServerInputMessages<Message, ServerProtocolOptions>,

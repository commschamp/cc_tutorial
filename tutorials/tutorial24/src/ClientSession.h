...
public:
    ...
    using ClientProtocolOptions = tutorial24::options::ClientDefaultOptions;
        
    // Definition of all the used message classes
    using Msg1 = tutorial24::message::Msg1<Message, ClientProtocolOptions>;
    using Msg2 = tutorial24::message::Msg2<Message, ClientProtocolOptions>;
...
private:
    ...
    using Frame = 
        tutorial24::frame::Frame<
            Message,
            tutorial24::input::ClientInputMessages<Message, ClientProtocolOptions>,

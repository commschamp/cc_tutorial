...
/// @note Defined in tutorial24/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial24::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial24::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial24::options::DefaultOptions.
/// @headerfile tutorial24/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(tutorial24::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial24::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial24::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial24::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial24::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial24::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

...
#include "tutorial16/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial16::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial16::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

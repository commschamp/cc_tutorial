...
#include "tutorial16/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial16::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial16::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

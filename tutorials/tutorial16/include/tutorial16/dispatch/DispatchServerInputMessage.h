...
/// @note Defined in tutorial16/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial16::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial16::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial16::options::DefaultOptions.
/// @headerfile tutorial16/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial16::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial16::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial16::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial16::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial16::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial16::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

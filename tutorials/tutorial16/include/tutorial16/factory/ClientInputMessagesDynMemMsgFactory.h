...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            case tutorial16::MsgId_M1: return MsgPtr(new tutorial16::message::Msg1<TInterface, TProtOptions>);
            case tutorial16::MsgId_M2: return MsgPtr(new tutorial16::message::Msg2<TInterface, TProtOptions>);
            case tutorial16::MsgId_M3: return MsgPtr(new tutorial16::message::Msg3<TInterface, TProtOptions>);
            case tutorial16::MsgId_M4: return MsgPtr(new tutorial16::message::Msg4<TInterface, TProtOptions>);
            default: break;
        }
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (id)
        {
            case tutorial16::MsgId_M1: return 1U;
            case tutorial16::MsgId_M2: return 1U;
            case tutorial16::MsgId_M3: return 1U;
            case tutorial16::MsgId_M4: return 1U;
            default: break;
        }

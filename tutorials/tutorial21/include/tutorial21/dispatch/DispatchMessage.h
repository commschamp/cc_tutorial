...
/// @note Defined in tutorial21/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial21::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<tutorial21::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial21::options::DefaultOptions.
/// @headerfile tutorial21/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(tutorial21::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial21::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial21::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial21::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial21::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial21::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<tutorial21::options::DefaultOptions>;

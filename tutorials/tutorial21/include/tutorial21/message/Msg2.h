...
#include "tutorial21/message/Msg2Common.h"
...
/// @see @ref Msg2
/// @headerfile tutorial21/message/Msg2.h
...
/// @tparam TOpt Extra options
/// @headerfile tutorial21/message/Msg2.h
template <typename TMsgBase, typename TOpt = tutorial21::options::DefaultOptions>
class Msg2 : public
    comms::MessageBase<
        TMsgBase,
...
public:
    ...
    {
        return tutorial21::message::Msg2Common::name();
    }
};

...
#include "tutorial21/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial21::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial21::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

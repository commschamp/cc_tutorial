...
#include "tutorial21/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial21::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial21::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

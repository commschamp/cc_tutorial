...
///     like @ref tutorial11::options::DefaultOptions.
...
///     @code
///     using MyInterface = tutorial11::Message<...>;
///     using MyMsg1 = tutorial11::message::Msg1<MyInterface, tutorial11::options::DefaultOptions>;
///     using MyMsg2 = tutorial11::message::Msg2<MyInterface, tutorial11::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in tutorial11/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case tutorial11::MsgId_M1:
    {
        using MsgType = tutorial11::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial11::MsgId_M2:
    {
        using MsgType = tutorial11::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial11::MsgId_M3:
    {
        using MsgType = tutorial11::message::Msg3<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     tutorial11::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial11::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial11::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial11::options::DefaultOptions.
/// @headerfile tutorial11/dispatch/DispatchServerInputMessage.h
template <typename TProtOptions = tutorial11::options::DefaultOptions>
struct ServerInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial11::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial11::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial11::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial11::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial11::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial11::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref tutorial11::options::DefaultOptions as template parameter.
/// @note Defined in tutorial11/dispatch/DispatchServerInputMessage.h

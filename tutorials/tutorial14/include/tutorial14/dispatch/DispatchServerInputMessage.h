...
///     like @ref tutorial14::options::DefaultOptions.
...
///     @code
///     using MyInterface = tutorial14::Message<...>;
///     using MyMsg1 = tutorial14::message::Msg1<MyInterface, tutorial14::options::DefaultOptions>;
///     using MyMsg2 = tutorial14::message::Msg2<MyInterface, tutorial14::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in tutorial14/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case tutorial14::MsgId_M1:
    {
        using MsgType = tutorial14::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case tutorial14::MsgId_M2:
    {
...
///     tutorial14::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial14::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial14::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial14::options::DefaultOptions.
/// @headerfile tutorial14/dispatch/DispatchServerInputMessage.h
template <typename TProtOptions = tutorial14::options::DefaultOptions>
struct ServerInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial14::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial14::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial14::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(tutorial14::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial14::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial14::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref tutorial14::options::DefaultOptions as template parameter.
/// @note Defined in tutorial14/dispatch/DispatchServerInputMessage.h

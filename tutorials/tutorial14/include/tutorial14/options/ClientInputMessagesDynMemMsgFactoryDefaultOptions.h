...
#include "tutorial14/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial14::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial14::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
/// @note Defined in tutorial13/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial13::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial13::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial13::options::DefaultOptions.
/// @headerfile "tutorial13/dispatch/DispatchClientInputMessage.h"
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial13::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial13::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial13::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial13::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial13::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial13::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<tutorial13::options::DefaultOptions>;

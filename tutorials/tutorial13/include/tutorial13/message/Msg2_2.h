...
#include "tutorial13/message/Msg2_2Common.h"
...
/// @see @ref Msg2_2
/// @headerfile tutorial13/message/Msg2_2.h
...
struct Msg2_2Fields
{
    ...
    public:
        ...
        {
            return tutorial13::message::Msg2_2FieldsCommon::TypeCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return tutorial13::message::Msg2_2FieldsCommon::TypeCommon::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return tutorial13::message::Msg2_2FieldsCommon::F1Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return tutorial13::message::Msg2_2FieldsCommon::F1Common::name();
        }
    };
...
public:
    ...
    static_assert(MsgMinLen == 5, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 5, "Unexpected max serialisation length");

    /// @brief Name of the message.
    static const char* doName()
    {
        return tutorial13::message::Msg2_2Common::name();
    }
};

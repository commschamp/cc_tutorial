...
#include "tutorial13/message/Msg1_3Common.h"
...
/// @see @ref Msg1_3
/// @headerfile tutorial13/message/Msg1_3.h
...
struct Msg1_3Fields
{
    ...
    public:
        ...
        {
            return tutorial13::message::Msg1_3FieldsCommon::F1Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return tutorial13::message::Msg1_3FieldsCommon::F1Common::name();
        }
    };
...
public:
    ...
    {
        return tutorial13::message::Msg1_3Common::name();
    }
};

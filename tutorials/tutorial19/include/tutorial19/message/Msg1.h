...
#include "tutorial19/message/Msg1Common.h"
...
/// @see @ref Msg1
/// @headerfile tutorial19/message/Msg1.h
...
struct Msg1Fields
{
    ...
    public:
        ...
        {
            return tutorial19::message::Msg1FieldsCommon::F1Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return tutorial19::message::Msg1FieldsCommon::F1Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return tutorial19::message::Msg1FieldsCommon::F2Common::hasSpecials();
        }
    ...
    struct F2 : public
        comms::field::Optional<
            ...
            comms::option::def::ExistsSinceVersion<2>,
            comms::option::def::HasName    >
    {
        /// @brief Name of the field.
        static const char* name()
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return tutorial19::message::Msg1FieldsCommon::F3Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return tutorial19::message::Msg1FieldsCommon::F3Common::name();
        }
    };
    ...
    struct F3 : public
        comms::field::Optional<
            F3Field,
            comms::option::def::ExistsByDefault,
            comms::option::def::ExistsSinceVersion<5>,
            comms::option::def::HasName    >
    {
        /// @brief Name of the field.
        static const char* name()
...
public:
    ...
    {
        return tutorial19::message::Msg1Common::name();
    }
};

...
#include "tutorial19/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial19::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial19::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

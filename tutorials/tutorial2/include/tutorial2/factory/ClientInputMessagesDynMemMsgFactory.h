...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 1 /* 0x1 */: return MsgPtr(new tutorial2::message::Msg1<TInterface, TProtOptions>);
            case 2 /* 0x2 */: return MsgPtr(new tutorial2::message::Msg2<TInterface, TProtOptions>);
            case 3 /* 0x3 */: return MsgPtr(new tutorial2::message::Msg3<TInterface, TProtOptions>);
            case 4 /* 0x4 */: return MsgPtr(new tutorial2::message::Msg4<TInterface, TProtOptions>);
            case 5 /* 0x5 */: return MsgPtr(new tutorial2::message::Msg5<TInterface, TProtOptions>);
            case 6 /* 0x6 */: return MsgPtr(new tutorial2::message::Msg6<TInterface, TProtOptions>);
            case 7 /* 0x7 */: return MsgPtr(new tutorial2::message::Msg7<TInterface, TProtOptions>);
            case 8 /* 0x8 */: return MsgPtr(new tutorial2::message::Msg8<TInterface, TProtOptions>);
            case 9 /* 0x9 */: return MsgPtr(new tutorial2::message::Msg9<TInterface, TProtOptions>);
            case 10 /* 0xa */: return MsgPtr(new tutorial2::message::Msg10<TInterface, TProtOptions>);
            case 11 /* 0xb */: return MsgPtr(new tutorial2::message::Msg11<TInterface, TProtOptions>);
            case 12 /* 0xc */: return MsgPtr(new tutorial2::message::Msg12<TInterface, TProtOptions>);
            case 13 /* 0xd */: return MsgPtr(new tutorial2::message::Msg13<TInterface, TProtOptions>);
            case 14 /* 0xe */: return MsgPtr(new tutorial2::message::Msg14<TInterface, TProtOptions>);
            case 15 /* 0xf */: return MsgPtr(new tutorial2::message::Msg15<TInterface, TProtOptions>);
            case 16 /* 0x10 */: return MsgPtr(new tutorial2::message::Msg16<TInterface, TProtOptions>);
            case 17 /* 0x11 */: return MsgPtr(new tutorial2::message::Msg17<TInterface, TProtOptions>);
            case 18 /* 0x12 */: return MsgPtr(new tutorial2::message::Msg18<TInterface, TProtOptions>);
            default: break;
        }
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (static_cast<std::intmax_t>(id))
        {
            ...
            case 17 /* 0x11 */: return 1U;
            case 18 /* 0x12 */: return 1U;
            default: break;
        }

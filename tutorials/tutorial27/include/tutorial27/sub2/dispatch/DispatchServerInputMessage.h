...
/// @note Defined in tutorial27/sub2/dispatch/DispatchServerInputMessage.h
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial27::options::DefaultOptions.
/// @headerfile tutorial27/sub2/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial27::sub2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial27::sub2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial27::sub2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial27::sub2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

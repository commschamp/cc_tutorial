...
#include "tutorial27/sub2/field/MsgId.h"
#include "tutorial27/sub2/frame/FrameCommon.h"
...
/// @see @ref Frame
/// @headerfile tutorial27/sub2/frame/Frame.h
...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial27::sub2::frame::FrameLayers::Data layer
        class Field : public
            comms::field::ArrayList<
                tutorial27::field::FieldBase<>,
                std::uint8_t,
                typename TOpt::sub2::frame::FrameLayers::DataMembers::Field,
    ...
    using Id =
        comms::frame::MsgIdLayer<
            tutorial27::sub2::field::MsgId<
                TOpt
            >,
            TMessage,
            TAllMessages,
            Data,
            typename TOpt::sub2::frame::FrameLayers::Id
        >;
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            {
                return tutorial27::sub2::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial27::sub2::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };
...
template <
   typename TMessage,
   typename TAllMessages = tutorial27::sub2::input::AllMessages<TMessage>,

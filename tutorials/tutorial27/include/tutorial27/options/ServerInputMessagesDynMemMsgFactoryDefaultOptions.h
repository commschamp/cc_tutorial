...
#include "tutorial27/sub1/factory/ServerInputMessagesDynMemMsgFactory.h"
#include "tutorial27/sub2/factory/ServerInputMessagesDynMemMsgFactory.h"
...
struct ServerInputMessagesDynMemMsgFactoryDefaultOptionsT : public TBase
{
    ...
    using sub1_MsgFactory =
        tutorial27::sub1::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

    /// @brief Alias to actual message factory class.
    /// @details Exposes the same template parameters as @b comms::MsgFactory.
    template <typename TInterface, typename TAllMessages, typename... TOptions>
    using sub2_MsgFactory =
        tutorial27::sub2::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
#include "tutorial27/sub1/input/AllMessages.h"
...
/// @note Defined in tutorial27/sub1/dispatch/DispatchMessage.h
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial27::options::DefaultOptions.
/// @headerfile tutorial27/sub1/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial27::sub1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial27::sub1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial27::sub1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial27::sub1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

...
/// @note Defined in tutorial27/sub1/dispatch/DispatchClientInputMessage.h
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial27::options::DefaultOptions.
/// @headerfile tutorial27/sub1/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial27::sub1::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial27::sub1::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial27::sub1::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial27::sub1::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

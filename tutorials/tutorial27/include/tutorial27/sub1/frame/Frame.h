...
#include "tutorial27/field/FieldBase.h"
#include "tutorial27/options/DefaultOptions.h"
#include "tutorial27/sub1/frame/FrameCommon.h"
...
/// @see @ref Frame
/// @headerfile tutorial27/sub1/frame/Frame.h
...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial27::sub1::frame::FrameLayers::Data layer
        class Field : public
            comms::field::ArrayList<
                tutorial27::field::FieldBase<>,
                std::uint8_t,
                typename TOpt::sub1::frame::FrameLayers::DataMembers::Field,
    ...
    struct IdMembers
    {
        ...
        public:
            ...
            {
                return tutorial27::sub1::frame::FrameLayersCommon::IdMembersCommon::IdFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial27::sub1::frame::FrameLayersCommon::IdMembersCommon::IdFieldCommon::name();
            }
        };
    };
    ...
    using Id =
        comms::frame::MsgIdLayer<
            ...
            TAllMessages,
            Data,
            typename TOpt::sub1::frame::FrameLayers::Id
        >;
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return tutorial27::sub1::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial27::sub1::frame::FrameLayersCommon::SizeMembersCommon::SizeFieldCommon::name();
            }
        };
    };
...
template <
   typename TMessage,
   typename TAllMessages = tutorial27::sub1::input::AllMessages<TMessage>,
   typename TOpt = tutorial27::options::DefaultOptions
>
class Frame : public

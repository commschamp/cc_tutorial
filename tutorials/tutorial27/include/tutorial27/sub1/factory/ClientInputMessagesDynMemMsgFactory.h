...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 0 /* 0x0 */: 
                if (idx == 0) {
                    return MsgPtr(new tutorial27::sub1::message::Msg1<TInterface, TProtOptions>);
                }
                if (idx == 1) {
                    return MsgPtr(new tutorial27::sub1::message::Msg2<TInterface, TProtOptions>);
                }
                if (idx == 2) {
                    return MsgPtr(new tutorial27::sub1::message::Msg3<TInterface, TProtOptions>);
                }
                break;

...
struct LengthMembers
{
    ...
    public:
        ...
        using SpecialNameInfo = tutorial22::field::LengthMembersCommon::ShortCommon::SpecialNameInfo;

        /// @brief Type returned from @ref specialNamesMap() member function.
        /// @details The @b first value of the pair is pointer to the map array,
        ///     The @b second value of the pair is the size of the array.
        using SpecialNamesMapInfo = tutorial22::field::LengthMembersCommon::ShortCommon::SpecialNamesMapInfo;

        /// @brief Compile time detection of special values presence.
        static constexpr bool hasSpecials()
        {
            return tutorial22::field::LengthMembersCommon::ShortCommon::hasSpecials();
        }

        /// @brief Special value <b>"LongForm"</b>.
        /// @see @ref tutorial22::field::LengthMembersCommon::ShortCommon::valueLongForm().
        static constexpr ValueType valueLongForm()
        {
            return tutorial22::field::LengthMembersCommon::ShortCommon::valueLongForm();
        }
        ...
        {
            return tutorial22::field::LengthMembersCommon::ShortCommon::specialNamesMap();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return tutorial22::field::LengthMembersCommon::ShortCommon::name();
        }
    };
    ...
    struct LongMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return tutorial22::field::LengthMembersCommon::LongMembersCommon::ActLongCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return tutorial22::field::LengthMembersCommon::LongMembersCommon::ActLongCommon::name();
            }
        };
    };
    ...
    public:
        ...
        static const char* name()
        {
            return tutorial22::field::LengthMembersCommon::LongCommon::name();
        }
    };
...
public:
    ...
    ///         for tutorial22::field::LengthMembers::Short member field.
    ///     @li @b FieldIdx_long index, @b Field_long type and @b field_long() access function -
    ///         for tutorial22::field::LengthMembers::Long member field.
    ...
    static const char* name()
    {
        return tutorial22::field::LengthCommon::name();
    }
...
private:
    ...
    bool refresh_long()
    {
        ...
        if (field_short().getValue() == static_cast<typename Field_short::ValueType>(255)) {

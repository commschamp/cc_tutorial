...
public:
    ...
    using MemberNameInfo = tutorial22::field::TlvPropCommon::MemberNameInfo;

    /// @brief Type returned from @ref memberNamesMap() member function.
    /// @see @ref tutorial22::field::TlvPropCommon::MemberNamesMapInfo.
    using MemberNamesMapInfo = tutorial22::field::TlvPropCommon::MemberNamesMapInfo;
    ...
    /// @see @ref tutorial22::field::TlvPropCommon::memberName().
    static const char* memberName(std::size_t idx)
    {
        return tutorial22::field::TlvPropCommon::memberName(idx);
    }
    ...
    /// @see @ref tutorial22::field::TlvPropCommon::memberNamesMap().
    static MemberNamesMapInfo memberNamesMap()
    {
        return tutorial22::field::TlvPropCommon::memberNamesMap();
    }

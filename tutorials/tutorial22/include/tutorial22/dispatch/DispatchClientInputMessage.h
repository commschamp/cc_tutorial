...
/// @note Defined in tutorial22/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial22::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial22::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial22::options::DefaultOptions.
/// @headerfile tutorial22/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial22::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial22::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial22::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial22::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial22::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial22::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<tutorial22::options::DefaultOptions>;

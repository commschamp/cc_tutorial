...
///     like @ref tutorial23::options::DefaultOptions.
...
///     @code
///     using MyInterface = tutorial23::Message<...>;
///     using MyMsg1 = tutorial23::message::Msg1<MyInterface, tutorial23::options::DefaultOptions>;
///     using MySomeOtherMessage = SomeOtherMessage<MyInterface, tutorial23::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in tutorial23/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    case 1 /* 0x1 */:
    {
        using MsgType = tutorial23::message::Msg1<InterfaceType, TProtOptions>;
...
///     tutorial23::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial23::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial23::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial23::options::DefaultOptions.
/// @headerfile tutorial23/dispatch/DispatchServerInputMessage.h
template <typename TProtOptions = tutorial23::options::DefaultOptions>
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial23::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial23::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial23::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial23::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref tutorial23::options::DefaultOptions as template parameter.
/// @note Defined in tutorial23/dispatch/DispatchServerInputMessage.h

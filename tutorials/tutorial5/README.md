...
## Full Frame
The last (outermost) layer is actually used as a protocol framing manager.
```cpp
...
will put some dummy (`0`) two bytes as the checksum and return `commms::ErrorStatus::UpdateRequired`

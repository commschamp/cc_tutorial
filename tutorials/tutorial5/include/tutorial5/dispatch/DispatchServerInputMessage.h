...
/// @note Defined in tutorial5/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial5::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<tutorial5::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial5::options::DefaultOptions.
/// @headerfile tutorial5/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial5::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial5::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial5::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial5::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial5::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial5::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

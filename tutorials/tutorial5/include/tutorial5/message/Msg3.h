...
#include "tutorial5/message/Msg3Common.h"
...
/// @see @ref Msg3
/// @headerfile tutorial5/message/Msg3.h
...
class Msg3 : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<tutorial5::MsgId_M3>,
...
public:
    ...
    {
        return tutorial5::message::Msg3Common::name();
    }
};

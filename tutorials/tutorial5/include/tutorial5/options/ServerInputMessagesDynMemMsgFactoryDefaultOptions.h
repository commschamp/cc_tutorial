...
#include "tutorial5/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref tutorial5::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = tutorial5::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

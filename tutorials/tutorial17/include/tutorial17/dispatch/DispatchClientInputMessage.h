...
/// @note Defined in tutorial17/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial17::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<tutorial17::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref tutorial17::options::DefaultOptions.
/// @headerfile tutorial17/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(tutorial17::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(tutorial17::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return tutorial17::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(tutorial17::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(tutorial17::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return tutorial17::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

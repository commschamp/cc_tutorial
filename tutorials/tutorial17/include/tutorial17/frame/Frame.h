...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref tutorial17::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct SizeWithFlagsMembers
    {
        ...
        struct FieldMembers
        {
            ...
            public:
                ...
                {
                    return tutorial17::frame::FrameLayersCommon::SizeWithFlagsMembersCommon::FieldMembersCommon::FlagsCommon::bitName(idx);
                }
        ...
        struct FieldMembers
        {
            ...
            class Flags : public
                comms::field::BitmaskValue<
                    ...
                    comms::option::def::BitmaskReservedBits<0x2, 0x0>
                >
            {
                using Base =
                    comms::field::BitmaskValue<
            ...
            public:
                ...
                static const char* bitName(std::size_t idx)
                {
                    return tutorial17::frame::FrameLayersCommon::IdWithFlagsMembersCommon::FieldMembersCommon::FlagsCommon::bitName(idx);
                }

...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref howto5::frame::FrameLayers::Data layer
        class Field : public
...
public:
    ...
    ///     @li @b Layer_versionWithFlags type and @b layer_versionWithFlags() function
    ///         for @ref FrameLayers::VersionWithFlags layer.

...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            case howto5::MsgId_M1: return MsgPtr(new howto5::message::Msg1<TInterface, TProtOptions>);
            case howto5::MsgId_M2: return MsgPtr(new howto5::message::Msg2<TInterface, TProtOptions>);
            default: break;
        }
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (id)
        {
            case howto5::MsgId_M1: return 1U;
            case howto5::MsgId_M2: return 1U;
            default: break;
        }

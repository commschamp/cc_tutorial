...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto5::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto5::options::DefaultOptions>(id, idx, msg, handler);
}
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(howto5::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto5::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto5::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto5::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto5::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto5::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

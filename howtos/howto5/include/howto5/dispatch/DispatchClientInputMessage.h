...
///     @code
///     using MyInterface = howto5::Interface<...>;
///     using MyMsg1 = howto5::message::Msg1<MyInterface, howto5::options::DefaultOptions>;
///     using MyMsg2 = howto5::message::Msg2<MyInterface, howto5::options::DefaultOptions>;
///     struct MyHandler {
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case howto5::MsgId_M1:
    {
        using MsgType = howto5::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case howto5::MsgId_M2:
    {
        using MsgType = howto5::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     howto5::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchClientInputMessage()
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto5::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto5::options::DefaultOptions>(id, idx, msg, handler);
}
...
template <typename TProtOptions = howto5::options::DefaultOptions>
struct ClientInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(howto5::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto5::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto5::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchClientInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(howto5::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto5::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto5::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

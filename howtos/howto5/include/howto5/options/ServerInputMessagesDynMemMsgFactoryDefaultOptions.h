...
#include "howto5/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto5::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto5::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

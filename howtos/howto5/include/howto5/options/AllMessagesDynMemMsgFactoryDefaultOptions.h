...
#include "howto5/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto5::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto5::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

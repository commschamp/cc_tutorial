...
#include "howto5/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto5::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto5::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

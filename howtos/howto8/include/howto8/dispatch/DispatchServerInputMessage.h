...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto8::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto8::options::DefaultOptions>(id, idx, msg, handler);
}
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(howto8::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto8::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto8::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto8::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto8::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto8::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

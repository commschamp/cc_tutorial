...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref howto8::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct IdMembers
    {
        ...
        struct FieldMembers
        {
            ...
            public:
                ...
                {
                    return howto8::frame::FrameLayersCommon::IdMembersCommon::FieldMembersCommon::CtrlCommon::bitName(idx);
                }

...
#include "howto8/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto8::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto8::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

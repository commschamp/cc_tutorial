...
///     using MySomeOtherMessage = howto4::message::SomeOtherMessage<MyInterface, howto4::options::DefaultOptions>;
///     struct MyHandler {
...
using ServerInputMsgDispatcherDefaultOptions =
    ServerInputMsgDispatcher<howto4::options::DefaultOptions>;

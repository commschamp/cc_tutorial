...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto4::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto4::options::DefaultOptions>(id, idx, msg, handler);
}
...
struct MsgDispatcher
{
    ...
    static auto dispatch(howto4::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto4::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto4::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto4::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto4::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return howto4::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

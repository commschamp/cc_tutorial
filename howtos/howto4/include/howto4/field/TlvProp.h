...
public:
    ...
    using MemberNameInfo = howto4::field::TlvPropCommon::MemberNameInfo;

    /// @brief Type returned from @ref memberNamesMap() member function.
    /// @see @ref howto4::field::TlvPropCommon::MemberNamesMapInfo.
    using MemberNamesMapInfo = howto4::field::TlvPropCommon::MemberNamesMapInfo;
    ...
    /// @see @ref howto4::field::TlvPropCommon::memberName().
    static const char* memberName(std::size_t idx)
    {
        return howto4::field::TlvPropCommon::memberName(idx);
    }
    ...
    /// @see @ref howto4::field::TlvPropCommon::memberNamesMap().
    static MemberNamesMapInfo memberNamesMap()
    {
        return howto4::field::TlvPropCommon::memberNamesMap();
    }

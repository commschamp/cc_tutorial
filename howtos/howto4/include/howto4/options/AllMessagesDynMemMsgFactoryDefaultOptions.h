...
#include "howto4/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto4::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto4::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

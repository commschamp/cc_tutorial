...
/// @note Defined in howto11/var1/dispatch/DispatchMessage.h
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto11::options::DefaultOptions.
/// @headerfile howto11/var1/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto11::var1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto11::var1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto11::var1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return howto11::var1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

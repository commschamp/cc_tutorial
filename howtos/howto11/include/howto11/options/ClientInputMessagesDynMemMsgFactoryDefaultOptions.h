...
#include "howto11/prot/factory/ClientInputMessagesDynMemMsgFactory.h"
#include "howto11/var1/factory/ClientInputMessagesDynMemMsgFactory.h"
#include "howto11/var2/factory/ClientInputMessagesDynMemMsgFactory.h"
...
struct ClientInputMessagesDynMemMsgFactoryDefaultOptionsT : public TBase
{
    ...
    using prot_MsgFactory =
        howto11::prot::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

    /// @brief Alias to actual message factory class.
    /// @details Exposes the same template parameters as @b comms::MsgFactory.
    template <typename TInterface, typename TAllMessages, typename... TOptions>
    using var1_MsgFactory =
        howto11::var1::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

    /// @brief Alias to actual message factory class.
    /// @details Exposes the same template parameters as @b comms::MsgFactory.
    template <typename TInterface, typename TAllMessages, typename... TOptions>
    using var2_MsgFactory =
        howto11::var2::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
/// @note Defined in howto11/var2/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto11::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto11::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto11::options::DefaultOptions.
/// @headerfile howto11/var2/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto11::var2::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto11::var2::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto11::var2::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto11::var2::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

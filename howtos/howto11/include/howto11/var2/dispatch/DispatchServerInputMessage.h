...
#include "howto11/var2/input/ServerInputMessages.h"
...
///     using MyProp4 = howto11::var2::message::Prop4<MyInterface, howto11::options::DefaultOptions>;
///     using MyProp5 = howto11::var2::message::Prop5<MyInterface, howto11::options::DefaultOptions>;
///     struct MyHandler {
///         void handle(MyProp4& msg) {...}
///         void handle(MyProp5& msg) {...}
///         ...
...
/// @note Defined in howto11/var2/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    case 10 /* 0xa */:
    {
        using MsgType = howto11::var2::message::Prop4<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case 15 /* 0xf */:
    {
        using MsgType = howto11::var2::message::Prop5<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case 25 /* 0x19 */:
    {
        using MsgType = howto11::var2::message::Prop6<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case 30 /* 0x1e */:
    {
        using MsgType = howto11::var2::message::Prop7<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto11::options::DefaultOptions.
/// @headerfile howto11/var2/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto11::var2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto11::var2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto11::var2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto11::var2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

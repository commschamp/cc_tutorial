...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (static_cast<std::intmax_t>(id)) {
            case 10 /* 0xa */: return MsgPtr(new howto11::var2::message::Prop4<TInterface, TProtOptions>);
            case 15 /* 0xf */: return MsgPtr(new howto11::var2::message::Prop5<TInterface, TProtOptions>);
            case 25 /* 0x19 */: return MsgPtr(new howto11::var2::message::Prop6<TInterface, TProtOptions>);
            case 30 /* 0x1e */: return MsgPtr(new howto11::var2::message::Prop7<TInterface, TProtOptions>);
            default: break;
        }
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (static_cast<std::intmax_t>(id))
        {
            ...
            case 25 /* 0x19 */: return 1;
            case 30 /* 0x1e */: return 1;
            default: break;
        }

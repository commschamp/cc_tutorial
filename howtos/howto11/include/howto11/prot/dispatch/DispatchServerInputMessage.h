...
#include "howto11/prot/input/ServerInputMessages.h"
...
///     using MyMsg1 = howto11::prot::message::Msg1<MyInterface, howto11::options::DefaultOptions>;
///     using MyMsg2 = howto11::prot::message::Msg2<MyInterface, howto11::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in howto11/prot/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    case 1 /* 0x1 */:
    {
        using MsgType = howto11::prot::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case 2 /* 0x2 */:
    {
        using MsgType = howto11::prot::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto11::options::DefaultOptions.
/// @headerfile howto11/prot/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto11::prot::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto11::prot::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto11::prot::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto11::prot::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

...
/// @note Defined in howto3/prot1/dispatch/DispatchMessage.h
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto3::options::DefaultOptions.
/// @headerfile howto3/prot1/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto3::prot1::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return howto3::prot1::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

...
///     using MyProt1PseudoMsg = howto3::prot1::message::Prot1PseudoMsg<MyInterface, howto3::options::DefaultOptions>;
///     using MySomeOtherMessage = SomeOtherMessage<MyInterface, howto3::options::DefaultOptions>;
///     struct MyHandler {
///         void handle(MyProt1PseudoMsg& msg) {...}
...
/// @note Defined in howto3/prot1/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    case 0 /* 0x0 */:
    {
        using MsgType = howto3::prot1::message::Prot1PseudoMsg<InterfaceType, TProtOptions>;
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto3::options::DefaultOptions.
/// @headerfile howto3/prot1/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot1::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto3::prot1::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot1::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto3::prot1::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

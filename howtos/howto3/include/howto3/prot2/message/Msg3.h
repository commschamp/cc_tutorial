...
#include "howto3/prot2/message/Msg3Common.h"
...
/// @see @ref Msg3
/// @headerfile howto3/prot2/message/Msg3.h
...
struct Msg3Fields
{
    ...
    public:
        ...
        {
            return howto3::prot2::message::Msg3FieldsCommon::F1Common::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return howto3::prot2::message::Msg3FieldsCommon::F1Common::name();
        }
    };
...
public:
    ...
    {
        return howto3::prot2::message::Msg3Common::name();
    }
};

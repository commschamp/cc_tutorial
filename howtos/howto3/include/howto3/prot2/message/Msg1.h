...
#include "howto3/prot2/message/Msg1Common.h"
...
/// @see @ref Msg1
/// @headerfile howto3/prot2/message/Msg1.h
...
struct Msg1Fields
{
    ...
    class F1 : public
        comms::field::String<
            ...
            typename TOpt::prot2::message::Msg1Fields::F1,
    ...
    public:
        ...
        {
            return howto3::prot2::message::Msg1FieldsCommon::F1Common::name();
        }
    };
...
public:
    ...
    {
        return howto3::prot2::message::Msg1Common::name();
    }
};

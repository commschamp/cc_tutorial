...
/// @note Defined in howto3/prot2/dispatch/DispatchMessage.h
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto3::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto3::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto3::options::DefaultOptions.
/// @headerfile howto3/prot2/dispatch/DispatchMessage.h
...
struct MsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot2::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto3::prot2::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot2::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return howto3::prot2::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }

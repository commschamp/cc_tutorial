...
/// @note Defined in howto3/prot2/dispatch/DispatchClientInputMessage.h
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto3::options::DefaultOptions.
/// @headerfile howto3/prot2/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot2::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto3::prot2::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot2::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto3::prot2::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

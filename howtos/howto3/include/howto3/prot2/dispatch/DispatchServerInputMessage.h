...
///     @code
///     using MyInterface = howto3::prot1::Prot1Interface<...>;
///     using MyMsg1 = howto3::prot2::message::Msg1<MyInterface, howto3::options::DefaultOptions>;
///     using MyMsg2 = howto3::prot2::message::Msg2<MyInterface, howto3::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in howto3/prot2/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    case 1 /* 0x1 */:
    {
        using MsgType = howto3::prot2::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case 2 /* 0x2 */:
    {
        using MsgType = howto3::prot2::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case 3 /* 0x3 */:
    {
        using MsgType = howto3::prot2::message::Msg3<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto3::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto3::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto3::options::DefaultOptions.
/// @headerfile howto3/prot2/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(TId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto3::prot2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(TId id, TMsg& msg, THandler& handler) ->
        decltype(howto3::prot2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto3::prot2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }

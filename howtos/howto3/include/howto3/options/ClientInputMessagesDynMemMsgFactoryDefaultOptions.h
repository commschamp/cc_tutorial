...
#include "howto3/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto3::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto3::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

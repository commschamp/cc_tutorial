...
#include "howto3/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto3::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto3::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

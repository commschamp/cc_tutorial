...
#include "howto3/prot1/factory/AllMessagesDynMemMsgFactory.h"
#include "howto3/prot2/factory/AllMessagesDynMemMsgFactory.h"
...
struct AllMessagesDynMemMsgFactoryDefaultOptionsT : public TBase
{
    ...
    using prot1_MsgFactory =
        howto3::prot1::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

    /// @brief Alias to actual message factory class.
    /// @details Exposes the same template parameters as @b comms::MsgFactory.
    template <typename TInterface, typename TAllMessages, typename... TOptions>
    using prot2_MsgFactory =
        howto3::prot2::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
#include "howto3/prot1/factory/ServerInputMessagesDynMemMsgFactory.h"
#include "howto3/prot2/factory/ServerInputMessagesDynMemMsgFactory.h"
...
struct ServerInputMessagesDynMemMsgFactoryDefaultOptionsT : public TBase
{
    ...
    using prot1_MsgFactory =
        howto3::prot1::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

    /// @brief Alias to actual message factory class.
    /// @details Exposes the same template parameters as @b comms::MsgFactory.
    template <typename TInterface, typename TAllMessages, typename... TOptions>
    using prot2_MsgFactory =
        howto3::prot2::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

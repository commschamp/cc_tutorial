...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(howto3::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto3::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto3::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto3::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto3::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto3::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ServerInputMsgDispatcherDefaultOptions =
    ServerInputMsgDispatcher<howto3::options::DefaultOptions>;

...
///    @ref howto6::message::Msg3 message and its fields.
...
struct Msg3FieldsCommon
{
    ...
    struct F1MembersCommon
    {
        ...
        ///     @ref howto6::message::Msg3Fields::F1Members::Length field.
        struct LengthCommon
        {
    ...
    struct F1Common
    {
        /// @brief Name of the @ref howto6::message::Msg3Fields::F1 field.
        static const char* name()
        {
            return "F1";
        }
...
struct Msg3Common
{
    /// @brief Name of the @ref howto6::message::Msg3 message.
    static const char* name()
    {
        return "Message 3";
    }

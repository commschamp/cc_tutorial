...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref howto6::frame::FrameLayers::Data layer
        class Field : public
...
public:
    ...
    ///     @li @b Layer_chekcusmType type and @b layer_chekcusmType() function
    ///         for @ref FrameLayers::ChekcusmType layer.

...
#include "howto6/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto6::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto6::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
#include "howto6/Interface.h"
#include "howto6/frame/Frame.h"
#include "howto6/input/ServerInputMessages.h"
#include "howto6/options/ServerDefaultOptions.h"
...
public:
    ...
    using ServerProtocolOptions = howto6::options::ServerDefaultOptions;
...
private:
    ...
    using Frame = 
        howto6::frame::Frame<
            Message,
            howto6::input::ServerInputMessages<Message, ServerProtocolOptions>,

...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto7::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto7::options::DefaultOptions>(id, idx, msg, handler);
}
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(howto7::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto7::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto7::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto7::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto7::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto7::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<howto7::options::DefaultOptions>;

...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto7::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto7::options::DefaultOptions>(id, idx, msg, handler);
}
...
struct MsgDispatcher
{
    ...
    static auto dispatch(howto7::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto7::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto7::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto7::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto7::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return howto7::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<howto7::options::DefaultOptions>;

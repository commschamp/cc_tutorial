...
#include "howto7/options/ServerDefaultOptions.h"
...
public:
    ...
    using ServerProtocolOptions = howto7::options::ServerDefaultOptions;
...
private:
    ...
    using Frame = 
        howto7::frame::Frame<
            Message,
            howto7::input::ServerInputMessages<Message, ServerProtocolOptions>,

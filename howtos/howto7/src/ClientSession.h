...
#include "howto7/Message.h"
#include "howto7/frame/Frame.h"
#include "howto7/input/ClientInputMessages.h"
#include "howto7/options/ClientDefaultOptions.h"
...
public:
    ...
    using ClientProtocolOptions = howto7::options::ClientDefaultOptions;
        
    // Definition of all the used message classes
    using Msg1 = howto7::message::Msg1<Message, ClientProtocolOptions>;
    using Msg2 = howto7::message::Msg2<Message, ClientProtocolOptions>;
    using Msg3 = howto7::message::Msg3<Message, ClientProtocolOptions>;
...
private:
    ...
    using Frame = 
        howto7::frame::Frame<
            Message,
            howto7::input::ClientInputMessages<Message, ClientProtocolOptions>,

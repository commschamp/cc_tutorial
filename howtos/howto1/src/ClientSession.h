...
#include "howto1/options/ClientDefaultOptions.h"
...
public:
    ...
    using ClientProtocolOptions = 
        howto1::options::DataViewDefaultOptionsT<
            howto1::options::ClientDefaultOptions
        >;
        
    // Definition of all the used message classes
    using Msg1 = howto1::message::Msg1<Message, ClientProtocolOptions>;
    using Msg2 = howto1::message::Msg2<Message, ClientProtocolOptions>;
...
private:
    ...
    using Frame = 
        howto1::frame::Frame<
            Message,
            howto1::input::ClientInputMessages<Message, ClientProtocolOptions>,

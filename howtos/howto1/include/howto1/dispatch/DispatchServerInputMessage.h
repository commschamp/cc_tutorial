...
///     @code
///     using MyInterface = howto1::Interface<...>;
///     using MyMsg1 = howto1::message::Msg1<MyInterface, howto1::options::DefaultOptions>;
///     using MyMsg2 = howto1::message::Msg2<MyInterface, howto1::options::DefaultOptions>;
///     struct MyHandler {
...
///     howto1::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto1::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto1::options::DefaultOptions>(id, idx, msg, handler);
}
...
template <typename TProtOptions = howto1::options::DefaultOptions>

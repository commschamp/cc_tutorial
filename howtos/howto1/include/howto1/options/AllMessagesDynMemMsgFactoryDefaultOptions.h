...
#include "howto1/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto1::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto1::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

...
#include "howto10/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto10::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto10::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

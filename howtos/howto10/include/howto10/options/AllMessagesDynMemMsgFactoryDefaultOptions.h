...
#include "howto10/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto10::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto10::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

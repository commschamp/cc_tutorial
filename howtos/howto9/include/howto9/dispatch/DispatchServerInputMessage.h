...
///     like @ref howto9::options::DefaultOptions.
...
///     @code
///     using MyInterface = howto9::Message<...>;
///     using MyMsg1 = howto9::message::Msg1<MyInterface, howto9::options::DefaultOptions>;
///     using MyMsg2 = howto9::message::Msg2<MyInterface, howto9::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in howto9/dispatch/DispatchServerInputMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case howto9::MsgId_M1:
    {
        using MsgType = howto9::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case howto9::MsgId_M2:
    {
        using MsgType = howto9::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case howto9::MsgId_M3:
    {
        using MsgType = howto9::message::Msg3<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     howto9::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchServerInputMessage()
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto9::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<howto9::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto9::options::DefaultOptions.
/// @headerfile howto9/dispatch/DispatchServerInputMessage.h
template <typename TProtOptions = howto9::options::DefaultOptions>
struct ServerInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(howto9::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto9::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto9::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(howto9::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto9::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto9::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref howto9::options::DefaultOptions as template parameter.
/// @note Defined in howto9/dispatch/DispatchServerInputMessage.h

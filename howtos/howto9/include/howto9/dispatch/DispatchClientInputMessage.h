...
/// @note Defined in howto9/dispatch/DispatchClientInputMessage.h
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto9::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchClientInputMessage<howto9::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref howto9::options::DefaultOptions.
/// @headerfile howto9/dispatch/DispatchClientInputMessage.h
...
struct ClientInputMsgDispatcher
{
    ...
    static auto dispatch(howto9::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto9::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto9::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto9::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto9::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return howto9::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }

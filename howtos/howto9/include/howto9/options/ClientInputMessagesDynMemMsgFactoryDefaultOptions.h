...
#include "howto9/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto9::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto9::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

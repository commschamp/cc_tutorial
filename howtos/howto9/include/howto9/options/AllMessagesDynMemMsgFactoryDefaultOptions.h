...
#include "howto9/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto9::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto9::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;

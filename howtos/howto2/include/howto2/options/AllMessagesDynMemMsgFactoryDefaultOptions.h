...
#include "howto2/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref howto2::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = howto2::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
};

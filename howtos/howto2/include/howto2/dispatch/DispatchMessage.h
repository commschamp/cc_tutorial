...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto2::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<howto2::options::DefaultOptions>(id, idx, msg, handler);
}
...
struct MsgDispatcher
{
    ...
    static auto dispatch(howto2::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(howto2::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return howto2::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(howto2::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(howto2::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return howto2::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<howto2::options::DefaultOptions>;

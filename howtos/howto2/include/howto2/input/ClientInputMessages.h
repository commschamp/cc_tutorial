...
#define HOWTO2_ALIASES_FOR_CLIENT_INPUT_MESSAGES(prefix_, suffix_, interface_, opts_) \
    using prefix_ ## Msg1 ## suffix_ = howto2::message::Msg1<interface_, opts_>; \
    using prefix_ ## Msg2 ## suffix_ = howto2::message::Msg2<interface_, opts_>; \
    using prefix_ ## Msg3 ## suffix_ = howto2::message::Msg3<interface_, opts_>; \
    using prefix_ ## Msg4 ## suffix_ = howto2::message::Msg4<interface_, opts_>;

/// @brief Create type aliases for the client input messages of the protocol using default options.
/// @param prefix_ Prefix of the alias message type.
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define HOWTO2_ALIASES_FOR_CLIENT_INPUT_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    HOWTO2_ALIASES_FOR_CLIENT_INPUT_MESSAGES(prefix_, suffix_, interface_, howto2::options::DefaultOptions)
